...
public class VisualizarDoacao extends javax.swing.JInternalFrame {
    ...
    public VisualizarDoacao(JDesktopPane dashboard, int idPedido, String emailFuncionario, String funcao) {
        initComponents();
        jBConfirmarEntrega.setVisible(false);
        ...
        if (this.funcao.equals("FUNCIONARIO")) {
            jBConfirmarEntrega.setVisible(true);
            jBAceitar.setVisible(false);
            jBNegar.setVisible(false);
        }
    ...
    private void buscarPedido() {
        ...
        try {
            ...
            if (servicoModel != null) {
                ...
                if(servicoModel.getStatusPedido().equals("ANDAMENTO")){
                    jBAceitar.setEnabled(false);
                    jBNegar.setEnabled(true);
                }
                
                if(servicoModel.getStatusPedido().equals("CANCELADO")){
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Visualizar Pedido de Doação");
        ...
        jLabel2.setText("Confira o pedido de doação");
        ...
        jPanel1.add(jBAceitar, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 370, 110, 40));
        ...
        jTDataPedido.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jPanel1.add(jBNegar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 370, 110, 40));
    ...
    private void jBProcurarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBProcurarClienteActionPerformed
        ...
        final VisualizarDoacao dashboard = this;
    ...
    private void jBAceitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAceitarActionPerformed
        int confirmacao = JOptionPane.showConfirmDialog(
            null,
            "Tem certeza de que deseja confirmar o pedido de doação?",
            "Confirmar Pedido",
        ...
        if (confirmacao == JOptionPane.YES_OPTION) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (autenticar) {
                    HttpConnection httpConnection = new HttpConnection();
                    boolean response = httpConnection.aceitarPedido(this.idPedido);

                    if (response) {
                        JOptionPane.showMessageDialog(null, "Pedido confirmado com sucesso.");
                        dispose();
                    } else {
                        JOptionPane.showMessageDialog(null, "ERRO: erro ao confirmar o pedido.");
                    }
                }else {
    ...
    private void jBConfirmarEntregaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBConfirmarEntregaActionPerformed
        // TODO add your handling code here:
        if(jCStatus.getSelectedItem().equals("Andamento")){
            // Pergunta de confirmação ao funcionário
            int resposta = JOptionPane.showConfirmDialog(null, 
                        "Tem certeza de que deseja concluir este pedido de doação?", 
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    ...
                    if (autenticar) {
                        HttpConnection httpConnection = new HttpConnection();
                        boolean response = httpConnection.concluirPedido(this.idPedido);

                        if (response) {
                            JOptionPane.showMessageDialog(null, "Pedido concluído com sucesso.");
                            dispose();
                        } else {
                            JOptionPane.showMessageDialog(null, "ERRO: falha ao tentar confirmar a entrega.");
                        }
                    }else {
                        JOptionPane.showMessageDialog(null, "ERRO: senha incorreta.");
                    }
            ...
            JOptionPane.showMessageDialog(null, "ERRO: pedido em análise.");
        }
    ...
    private void jBNegarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBNegarActionPerformed
        ...
        int confirmacao = JOptionPane.showConfirmDialog(
            null,
            "Tem certeza de que deseja cancelar o pedido de doação?",
            "Cancelar Pedido",
            JOptionPane.YES_NO_OPTION,
            JOptionPane.QUESTION_MESSAGE
        );
        ...
        if (confirmacao == JOptionPane.YES_OPTION) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (autenticar) {
                    HttpConnection httpConnection = new HttpConnection();
                    boolean response = httpConnection.cancelarPedido(this.idPedido);

                    if (response) {
                        JOptionPane.showMessageDialog(null, "Pedido cancelado com sucesso.");
                        buscarPedido();
                    } else {
                        JOptionPane.showMessageDialog(null, "ERRO: erro ao cancelar o pedido.");
                    }
                }else {
                    JOptionPane.showMessageDialog(null, "ERRO: senha incorreta.");
                }
    ...
    private void jBConfirmarEntregaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBConfirmarEntregaMouseEntered
        // TODO add your handling code here:
        jBConfirmarEntrega.setBackground(new java.awt.Color(51,51,51));
