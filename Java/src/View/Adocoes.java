...
import Utils.AdocaoRelatorioDTO;
 ...
 * @author Oruam
 */
public class Adocoes extends javax.swing.JInternalFrame {
    ...
    private void listarAdocoes() {
        ...
        DefaultTableModel Tabela = (DefaultTableModel) jTAdocoes.getModel();
        ...
        for (PedidoModel servico : servicos) {
            ...
            if (servico.getTipo().equals("ADOCAO")) {
                Object[] dados = {
    ...
    public Adocoes(JDesktopPane dashboard, String nomeFuncionario, String emailFuncionario, String funcao) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jBAnalisarPedidos = new javax.swing.JButton();
        ...
        jTAdocoes = new javax.swing.JTable();
        ...
        jPanel8.setForeground(new java.awt.Color(233, 233, 233));
        ...
        jPanel8.add(jBGerarRelatorio, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 150, 40));

        jPanel2.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 620, 170, 60));

        jPanel6.setBackground(new java.awt.Color(238, 238, 238));
        jPanel6.setForeground(new java.awt.Color(233, 233, 233));
        jPanel6.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jBAnalisarPedidos.setBackground(new java.awt.Color(24, 24, 24));
        jBAnalisarPedidos.setForeground(new java.awt.Color(204, 204, 204));
        jBAnalisarPedidos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/OlhoIcon.png"))); // NOI18N
        jBAnalisarPedidos.setText("Analisar pedidos");
        jBAnalisarPedidos.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(59, 59, 59)));
        jBAnalisarPedidos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jBAnalisarPedidos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jBAnalisarPedidosMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jBAnalisarPedidosMouseExited(evt);
            }
        });
        jBAnalisarPedidos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBAnalisarPedidosActionPerformed(evt);
            }
        });
        jPanel6.add(jBAnalisarPedidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 170, 40));

        jPanel2.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 190, 60));
        ...
        jTAdocoes.setShowHorizontalLines(true);
        jTAdocoes.setShowVerticalLines(false);
        jTAdocoes.setGridColor(new java.awt.Color(51,51,51));
        jTAdocoes.setBackground(new java.awt.Color(238, 238, 238));
        jTAdocoes.setIntercellSpacing(new Dimension(0, 10));
        jTAdocoes.setRowHeight(30);
        jTAdocoes.setForeground(new java.awt.Color(51,51,51));
        jTAdocoes.setSelectionBackground(new java.awt.Color(24,24,24));
        jTAdocoes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTAdocoes.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jTAdocoes.setSelectionBackground(new java.awt.Color(102,102,102));   // Fundo quando selecionado

        JTableHeader header = jTAdocoes.getTableHeader();
        ...
        jTAdocoes.setSelectionForeground(new java.awt.Color(204,204,204));
        jTAdocoes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTAdocoesMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTAdocoes);
        if (jTAdocoes.getColumnModel().getColumnCount() > 0) {
            jTAdocoes.getColumnModel().getColumn(0).setPreferredWidth(200);
            jTAdocoes.getColumnModel().getColumn(2).setPreferredWidth(40);
            jTAdocoes.getColumnModel().getColumn(4).setPreferredWidth(60);
            jTAdocoes.getColumnModel().getColumn(5).setPreferredWidth(20);
        }
    ...
    private void filtrarTabela(String textoFiltro){
        DefaultTableModel modelo = (DefaultTableModel) jTAdocoes.getModel();
        TableRowSorter<DefaultTableModel> obj = new TableRowSorter<>(modelo);
        jTAdocoes.setRowSorter(obj);
    ...
    private void jTAdocoesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTAdocoesMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jTAdocoesMouseClicked
    ...
    private void jBVisualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBVisualizarActionPerformed
        // TODO add your handling code here:
        int[] selectedRows = jTAdocoes.getSelectedRows();
        ...
        if(selectedRows.length == 0){
            ...
            servicoModel.setIdPedido(Integer.parseInt(jTAdocoes.getValueAt(jTAdocoes.getSelectedRow(), 5).toString()));
            
            VisualizarAdocao visualizarDoacao = new VisualizarAdocao(dashboard, servicoModel.getIdPedido(), this.emailFuncionario, this.funcao);
            dashboard.add(visualizarDoacao);
            visualizarDoacao.setVisible(true);
            visualizarDoacao.setBounds(350, 90, 701, 465);
        }
    ...
    private void jBCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCadastrarActionPerformed
        CadastrarAdocao cadastrarAdocao = new CadastrarAdocao(dashboard, this.emailFuncionario, this.funcao);
        dashboard.add(cadastrarAdocao);
        cadastrarAdocao.setVisible(true);
        cadastrarAdocao.setBounds(400, 60, 421, 526);
    }//GEN-LAST:event_jBCadastrarActionPerformed

    private void jBAnalisarPedidosMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBAnalisarPedidosMouseEntered
        // TODO add your handling code here:
        jBAnalisarPedidos.setBackground(new java.awt.Color(51,51,51));
    }//GEN-LAST:event_jBAnalisarPedidosMouseEntered

    private void jBAnalisarPedidosMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBAnalisarPedidosMouseExited
        // TODO add your handling code here:
        jBAnalisarPedidos.setBackground(new java.awt.Color(24,24,24));
    }//GEN-LAST:event_jBAnalisarPedidosMouseExited

    private void jBAnalisarPedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAnalisarPedidosActionPerformed
        // Cria a nova tela de Comprovantes
        Comprovantes comprovantes = new Comprovantes(DashboardAdministrador, this.emailFuncionario, this.funcao);
        DashboardAdministrador.add(comprovantes); // Adiciona a nova tela ao DesktopPane
        comprovantes.setVisible(true); // Torna a nova tela visível
        comprovantes.setBounds(350, 50, 720, 584); // Define o tamanho e a posição
    }//GEN-LAST:event_jBAnalisarPedidosActionPerformed
    ...
    private void jBGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGerarRelatorioActionPerformed
        ...
        AdocaoRelatorioDTO relatorioDTO = new AdocaoRelatorioDTO();

        // Lista para armazenar os pedidos da tabela
        List<PedidoModel> pedidos = new ArrayList<>();

        // Obtém o modelo da tabela
        DefaultTableModel tableModel = (DefaultTableModel) jTAdocoes.getModel();
        ...
        AdocaoRelatorioDTO response = httpConnection.gerarRelatorioAdocoes(relatorioDTO);

        if (response.getRelatorio() != null) {
            // Define o nome padrão do arquivo
            String nomePadraoArquivo = "RelatorioAdocoes.pdf";

            // Salva o relatório no sistema
            salvarRelatorio(response.getRelatorio(), nomePadraoArquivo);
        } else {
            JOptionPane.showMessageDialog(null, "ERRO: falha ao tentar gerar o relatório de adoções.");
        }
    ...
    private javax.swing.JButton jBAnalisarPedidos;
    ...
    private javax.swing.JTable jTAdocoes;
